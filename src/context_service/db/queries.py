...
# TODO: remove aliases after all callers are updated to v2 APIs
...
CREATE_PROPOSED_BELIEF = CREATE_PENDING_BELIEF
GET_PROPOSED_BELIEF = GET_PENDING_BELIEF
ACCEPT_PROPOSED_BELIEF = ACCEPT_PENDING_BELIEF
REJECT_PROPOSED_BELIEF = REJECT_PENDING_BELIEF

# TODO: remove stubs after all callers are updated to v2 APIs
# Cluster-related query stubs (clustering removed in v2)
GET_RECENTLY_REJECTED_PROPOSAL_FOR_CLUSTER = "RETURN null LIMIT 0"
LIST_DENSE_CLUSTERS_WITHOUT_BELIEF_OR_PROPOSAL = "RETURN null LIMIT 0"
