...
def mock_deps():
    with (
        patch("context_service.mcp.tools.context_assert.get_mcp_auth_context") as auth_mock,
        ...
        patch(
            "context_service.mcp.tools.context_assert.get_silo_service", return_value=MagicMock()
        ),
        patch(
