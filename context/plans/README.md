...
| Plan | Description | Status |
|------|-------------|--------|
| [2026-06-04-supersession-chain-retrieval.md](./2026-06-04-supersession-chain-retrieval.md) | New `history` MCP tool for querying supersession chains | Ready to execute |
