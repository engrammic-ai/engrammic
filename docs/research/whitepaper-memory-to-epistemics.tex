...
\hypersetup{
    ...
    pdftitle={From Memory to Epistemics},
...
% TITLE
% ------------------------------------------------------------
\title{From Memory to Epistemics\\[0.4em]{\large\normalfont The architectural case for externalized epistemics.}}
...
CITE (Context In Tiered Epistemology) implements EAG as a four-layer architecture with Meta-Memory as cross-cutting infrastructure:
